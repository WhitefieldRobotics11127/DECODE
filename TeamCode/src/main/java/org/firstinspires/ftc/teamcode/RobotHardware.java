...
public class RobotHardware {
    ...
    private DcMotorEx leftLauncherMotor, rightLauncherMotor; // Motors for the launcher motors
    ...
    private DcMotorEx leftLauncher, rightLauncher; //Motors for launchers
    ...
    public void init(boolean vision) {
        ...
        //launcherMotorLeft = auxDeadwheelEncoder; // Use the same hardware mapping as the auxiliary odometry encoder
        leftLauncherMotor = myOpMode.hardwareMap.get(DcMotorEx.class, "left_launcher_motor");
        rightLauncherMotor = myOpMode.hardwareMap.get(DcMotorEx.class, "right_launcher_motor");
        kebobMotor = myOpMode.hardwareMap.get(DcMotorEx.class, "kebob_motor");
        //armRotationPositionSensor = myOpMode.hardwareMap.get(AnalogInput.class, "arm_rot_pos");
        lockServo = myOpMode.hardwareMap.get(Servo.class, "lock_servo");
